...
export default function AdminPage() {
  ...
  const checkAdmin = async () => {
    const isAdmin = await profileService.isCurrentUserAdmin();
    if (!isAdmin) {
      return (
        <DashboardLayout>
          <div className="flex justify-center items-center h-64">
            <div className="text-lg text-muted-foreground">Zugriff verweigert. Nur für Administratoren.</div>
          </div>
        </DashboardLayout>
      );
    }
  ...
  const loadData = async () => {
    try {
      ...
      setPendingTransactions(pendingWithdrawalsData);
  ...
  const updateSetting = async (key: string, value: string) => {
    try {
      ...
      toast({
        title: "Gespeichert",
        description: "Die Link-Einstellung wurde erfolgreich aktualisiert."
      });
    } catch (error) {
  ...
  return (
    <>
      <SEO 
        title="Admin Dashboard - Finanzportal"
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <Tabs defaultValue="overview" className="w-full">
              <TabsList className="grid w-full grid-cols-6 lg:grid-cols-6 mb-8">
                ...
                <TabsTrigger value="settings">Links</TabsTrigger>
              </TabsList>
              ...
              {/* Link-Einstellungen Tab */}
              <TabsContent value="settings">
                <Card>
                  <CardHeader>
                    <CardTitle>Website Link-Einstellungen</CardTitle>
                    <CardDescription>
                      Verwalten Sie hier die URLs für wichtige Website-Links. Diese werden sofort auf allen Seiten aktualisiert.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    {/* Home Button URL */}
                    <div className="space-y-2">
                      <Label htmlFor="home-url" className="text-base">Finanzportal Home-Button URL</Label>
                      <p className="text-sm text-muted-foreground">
                        Dieser Link wird geöffnet, wenn Benutzer auf das "Finanzportal"-Logo oben links im Dashboard klicken.
                      </p>
                    ...
                    {/* Website Button URL */}
                    <div className="space-y-2">
                      <Label htmlFor="website-url" className="text-base">"Zur Website"-Button URL</Label>
                      <p className="text-sm text-muted-foreground">
                        Dieser Link wird geöffnet, wenn Benutzer auf der Info-Seite ganz unten auf "Zur Website" klicken.
                      </p>
                      <div className="flex gap-2 max-w-2xl">
                        <input
                          id="website-url"
