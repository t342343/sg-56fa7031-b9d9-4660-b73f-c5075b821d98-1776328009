...
export default function AdminPage() {
  ...
  const loadData = async () => {
    try {
      ...
      // Lade abgeschlossene Auszahlungen
      const { data: completedTx, error: completedError } = await supabase
        .from("withdrawals")
        .select("*")
        .eq("status", "completed");
  ...
  const updateSetting = async (key: string, value: string) => {
    try {
      ...
      toast({
        ...
        description: "Die Link-Einstellung wurde aktualisiert"
      });
    } catch (error) {
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="home-url">Finanzportal Home-Button URL</Label>
                    <p className="text-sm text-muted-foreground">
                      Link für den "Finanzportal"-Button oben links im Dashboard
                    </p>
                    <div className="flex gap-2">
                      <input
                        id="home-url"
                  ...
                  {/* Website Button URL */}
                  <div className="space-y-2">
                    <Label htmlFor="website-url">"Zur Website"-Button URL</Label>
                    <p className="text-sm text-muted-foreground">
